							...
							<div class="div747w444h" >
								...
								<p class="ptop180 tc p747w411h" id="inn" >
			                 		...
			                 		<tr>
				                          	...
				                          	<th class="list_title" align="center" width="10%">序号</td>
				                      		<th class="list_title" align="center" width="30%">活动</td>
				                      		<th class="list_title" align="center" width="15%">活动办理时间</td>
				                      		<th class="list_title" align="center" width="15%">活动中止时间</td>
				                      		<th class="list_title" align="center" width="30%">提前中止原因</td>
							     		</tr>
								        	...
								        	<s:iterator value="resList" status="result">
								            	...
								            	<td align="center"><s:property value="#result.index+1"/></td>
								                	<s:iterator value="resList.get(#result.index)" status="res" id="back">
								                	  ...
								                	  <s:if test="#res.index==2||#res.index==0||#res.index==1||#res.index==6">
