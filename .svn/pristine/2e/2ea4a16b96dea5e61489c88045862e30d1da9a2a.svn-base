			...
			<div class="pl30">
				<div class="b257 ">
					<div class="bg bg257"></div>
      					...
      					<a title="投入纸币" href="#" class="on">4. 投入纸币</a>
				 	...
				 	<div class="bg bg712"></div>
     					...
     					<div class="p40 pr0">
       					...
       					<div class=" pay_money_wrap2">
       					 	<p class="pay_all">
       					 		<span style="padding-left:80px;">已投入：</span><input type="text" id="tMoney" name="tMoney" value="0" readonly="readonly" /><span class="yellow">元</span>&nbsp;&nbsp;
       					 		<span class="yellow">应缴：<s:property value="#request.prepayFee" />元</span>
       					...
       					<div>
       					 	...
       					 	<div style="padding-top:120px; padding-left:30px;" class="btn_box cancle fl" id="cancelBusi">
       					 		<a title="取消本次交易" href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="cancelBusi();return false;">取消本次交易</a>
       					 	</div>
       					 	...
       					 	<div style="padding-top:120px; padding-left:30px; display:none" class="btn_box buy_enable fl" id="commitBusi">
       					 		<a title="交费" href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="openWindow_wait('pls_wait');return false;">缴费</a>
       					 	</div>
       					</div>
     					</div>
				 </div>
