  				...
  				<div class="pl30">
  					...
  					<div class="b712">
      					...
      					<div class="p40 pr0">
      						...
      						<p class="tit_desc pl40 ">交费金额：<span class="yellow"><s:property value='priBackMoney' />元</span> </p>
      						<div class="blank20"></div>
        					<div class="line w625"></div>
       						<div class="blank30"></div>
       						<div class="recharge_result tc">
       							<p class="title yellow pt30">您的优惠受理已成功！</p>
          						<p class="desc pt20"><s:property value="errormessage" /></p>
          						...
          						<s:else>
									...
									%>
									<s:if test='hasMultiInvoices == "true"'>
										<a href="javascript:void(0);" onclick="printInvoice('ALL');return false;" onmousedown="this.className='hover'" onmouseup="this.className=''">打印全部发票</a>
									</s:if>
									...
									<a href="javascript:void(0);" onclick="printInvoice('Single');return false;" onmousedown="this.className='hover'" onmouseup="this.className=''">打印单张发票</a>
									<%
									}
									%>          							
          						</div>
