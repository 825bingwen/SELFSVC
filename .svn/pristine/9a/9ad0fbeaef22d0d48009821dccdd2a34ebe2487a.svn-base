...
function doSub()
{
	...
	<body scroll="no">
		<form name="actform" method="post">
			...
			<input type="hidden" id="confirmUnbind" name="confirmUnbind" value="0"/>
			...
			<div class="main" id="main">
				...
				<div class="box service_transact_ok service_transact_fail m0auto">
					...
					<input type="button" id="btnJieyue" style="margin-top:-210px; margin-left:450px;" 
					class="bt2_liebiao white" value="解约" 
