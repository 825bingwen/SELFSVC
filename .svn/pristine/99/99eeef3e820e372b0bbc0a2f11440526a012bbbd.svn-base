		...
		<div class="b966 tc">
			...
			<div class=" p40">
				...
				<div class="blank60"></div>
					...
					<div align="left" style="width:650px;height: 500px" class="yellow fs30">	
					<br/>
					尊敬的客户：<br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;您好！您本次套餐转换已经成功。<br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;套餐名称：<s:property value="newProdName"/><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;生效时间：<s:property value="effectTime"/><br/><br/>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;感谢您的使用！
					</br>	
					</br>
					</div>
