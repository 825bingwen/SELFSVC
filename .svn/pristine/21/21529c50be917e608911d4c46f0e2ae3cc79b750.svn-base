...
public class Constants extends ConstantsBase
{
     ...
     * 积分查询表头
     */
    private static final String[] SCORE_TITLE = {"当前可用积分"};
     ...
     * 
     */
    private final static Object[] ISMG_SHOW = {new String[] {"【梦网短信清单】"},
    ...
    private static final String[] TYPE_TITLES = {"类型    对方号码   起始时间         时长  话费",
     ...
     * 套餐与固定费
     */
    private static final String[] CDR_FIXFEE_SHOW = {"套餐及固定费详单", "扣费时间,使用周期,套餐及固定费名称,金额(元)"};
     ...
     * 短彩信详单
     */
    private static final String[] CDR_SMS_SHOW = {"短/彩信详单", "时间,地区,对方号码,类型,业务代码,金额(元)"};
    
    /**
     * 上网详单
     */
    private static final String[] CDR_GPRSWLAN_SHOW = {"上网详单", "起始时间,通信地点,上网方式,时长,流量,套餐优惠,通信费(元)"};
    
    /**
     * 增值业务费
     */
    private static final String[] CDR_ISMG_SHOW = {"增值业务扣费记录", "时间,使用方式,业务名称,业务端口,费用(元)"};
	...
	public static Map<String, String[]> getCdrtypemap() {
		return CDRTYPEMAP;
	}
