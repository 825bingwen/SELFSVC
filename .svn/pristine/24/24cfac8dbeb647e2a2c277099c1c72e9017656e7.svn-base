...
<html>
	<head>
		...
		<style>
			...
			.scrollBody .scrollBar .btnTop{width:70px; top:-40px; height:40px; background:url(${sessionScope.basePath }images/arrow_up.png) no-repeat;_filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src="${sessionScope.basePath }images/arrow_up.png");_background:none}
			.scrollBody .scrollBar .btnDown{width:70px; bottom:-40px;left:-4px; height:40px; background:url(${sessionScope.basePath }images/arrow_down.png) no-repeat;_filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src="${sessionScope.basePath }images/arrow_down.png");_background:none}
			.scrollBody .scrollBar .iconScroll{width:66px; height:40px; line-height:36px; background:url(${sessionScope.basePath }images/bg_66_30.png) no-repeat; _filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(enabled=true, sizingMethod=scale, src="${sessionScope.basePath }images/bg_66_30.png");_background:none}
		</style>
	</head>
