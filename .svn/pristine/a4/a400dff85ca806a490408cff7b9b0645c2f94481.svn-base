...
function doSub(){
	...
	if (submitFlag == 0)
	{
		...
		document.actform.action = "${sessionScope.basePath }prodInstall/selectProd.action";
...
function doCancle()
{
	if (submitFlag == 0)
	{
		...
		document.actform.target = "_self";
		document.actform.action = "${sessionScope.basePath}prodInstall/agreement.action";
		document.actform.submit();	
	}			
}
</script>
							...
							<table width="100%" class="tb_blue" align="center">
								<tr>
									...
									<td width="40%" class="tc">
										<span class="yellow fs20"> <%=custName%></span>
									</td>
									<td width="20%" class="tc" rowspan="2" colspan="1">
										<span class="yellow fs20">
											<img src='${sessionScope.basePath}<s:property value="idCardPO.idCardPhoto" />' alt='<s:property value="idCardPO.idCardPhoto" />' />
										</span>
									</td>
								</tr>
								<tr>
