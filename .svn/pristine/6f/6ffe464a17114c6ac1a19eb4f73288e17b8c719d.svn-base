...
function OpenCom()
{
	...
	var ret;
	try{
		ret = window.parent.document.getElementById("idcardpluginid").OpenCom();
		return ret;
	}catch(e){
		return '-1';
	}
...
function InitIdCardReader()
{
	...
	var ret;
	try{
		ret = window.parent.document.getElementById("idcardpluginid").InitCardReader();
		return ret;
	}catch(e){
		return '-1';
	}
...
{
	//return '0欧阳天涯~男~汉~1989-12-20~山东省济南历下区~371520198912200001~历下区公安局~2003-04-09~2023-04-09~济南市历下区';
	var ret;
	try{
		ret = window.parent.document.getElementById("idcardpluginid").GetIdCardContent();
		return ret;
	}catch(e){
		return '-1';
	}
...
function GetIdCardStatus()
{
	...
	var ret;
	try{
		ret = window.parent.document.getElementById("idcardpluginid").GetIdCardStatus();
		return ret;
	}catch(e){
		return '-1';
	}
...
function CloseCardReader()
{
	...
	var ret;
	try{
		ret = window.parent.document.getElementById("idcardpluginid").CloseCardReader();
		return ret;
	}catch(e){
		return '-1';
	}
...
{
	//return 'images/prev1.png';
	var photoStream;
	try{
		photoStream = window.parent.document.getElementById("idcardpluginid").GetUserPhoto();
		return photoStream;
	}
	catch(b)
	{
