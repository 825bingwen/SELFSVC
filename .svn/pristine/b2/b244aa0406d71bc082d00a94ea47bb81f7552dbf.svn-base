...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		{	
			...
			var inputFee = document.getElementById('yingjiaoFee').value;
			...
			// 密码键盘输入金额，不能大于3000
			if(parseInt(parseInt(inputFee)*10 + key - 48) > 3000)
			{
				return false;
			}
		}
		...
		function selectPayType() 
		{
			...
			if (submitFlag == 0)
			{
				...
				writeDetailLog("<%=(String) PublicCache.getInstance().getCachedData(Constants.SH_CHARGELOG_DETAILFLAG) %>", 
						"交费金额：" + document.getElementById("yingjiaoFee").value);
				...
				<div class="pl30">
					...
					<div class="b712">
    					...
    					<div class="p40 pr0">
    						...
    						<p class="tit_arrow fs22"><span class="bg"></span>请选择您要充值交费的金额：<span class="yellow">（1元-3000元 ) </span>：</p>
    						<div class="blank10"></div>
    						<div class="custom_money pl30"><span id="redstar1" class="pl40 fs20 fl lh48">请输入金额：</span>
          						<input type="text" maxlength="4" id="yingjiaoFee" name="yingjiaoFee" class="text1 fl" onclick="MoveLast(event);"  value="" />
        					</div>
