									...
									<table width="100%" class="tb_blue">
										<tr>
											<s:iterator value="servicetitle" status="title">
												<th class="list_title tc" id="title<s:property value="#title.getIndex()"/>"
												    <s:if test="#title.getIndex() == 0">width="20%"</s:if>
												    <s:elseif test="#title.getIndex() == 1">width="48%"</s:elseif>
												    <s:else>width="16%"</s:else>>
										...
										<s:if test="result != null && result.size > 0">
											<s:iterator value="result" status="result">
												<tr>
													<s:iterator value="result.get(#result.index)" status="resultInner">
														<td class="tc" id="<s:property value="#resultInner.getIndex()"/>" >
