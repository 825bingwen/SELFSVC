		...
		function printInfo()
		{
			...
			var Ret3 = DPsListPrinter1.PrintPicture(1);
     		...
     		%>
	     		...
	     		Ret4 = DPsListPrinter1.PrintLine("       现金帐本余额:  <%=acctbalanceMap != null && acctbalanceMap.get("leftmoney1")!=null?acctbalanceMap.get("leftmoney1"):"" %>");
	     		Ret4 = DPsListPrinter1.PrintLine("       协议款余额:  <%=acctbalanceMap != null && acctbalanceMap.get("leftmoney2")!=null?acctbalanceMap.get("leftmoney2"):"" %>");
	     		Ret4 = DPsListPrinter1.PrintLine("       积分余额:  <%=scoreinfoMap != null && scoreinfoMap.get("thisavail")!=null?scoreinfoMap.get("thisavail"):"" %>");
	     		Ret4 = DPsListPrinter1.PrintLine("    本期消费:  <%=acctbalanceMap != null && acctbalanceMap.get("consume")!=null?acctbalanceMap.get("consume"):"" %>");
	     		Ret4 = DPsListPrinter1.PrintLine("    本期末欠款:  <%=acctbalanceMap != null && acctbalanceMap.get("debtfee")!=null?acctbalanceMap.get("debtfee"):"" %>");
	     		Ret4 = DPsListPrinter1.PrintLine("    ---------------------------------");
     		<%
     		}
     		%>
			...
			// 账户信息
			<%
			if (acctbalanceList != null && acctbalanceList.size() > 0)
			{
			%>
				Ret4 = DPsListPrinter1.PrintLine("    【账户信息】           ");
				<% 
				for (Map obj : acctbalanceList)
				{
				%>
					<%
											if ("0".equals(obj.get("accttype")))
											{
				    %>
				    							Ret4 = DPsListPrinter1.PrintLine("    帐本名称:话费账户");
				    <%
											}
											else if ("1".equals(obj.get("accttype")))
											{
					%>
												Ret4 = DPsListPrinter1.PrintLine("    帐本名称:协议款账户");
					<%
											}
											else
											{
					%>
												Ret4 = DPsListPrinter1.PrintLine("    帐本名称:<%=obj.get("accttype") %>");
					<%
											}
					%>
					
					Ret4 = DPsListPrinter1.PrintLine("    上期结余:<%=obj.get("lastval") %>");
					Ret4 = DPsListPrinter1.PrintLine("    本期收入:<%=obj.get("income") %>");
					Ret4 = DPsListPrinter1.PrintLine("    本期返还:<%=obj.get("returnfee") %>");
					Ret4 = DPsListPrinter1.PrintLine("    本期退费:<%=obj.get("backfee") %>");
					Ret4 = DPsListPrinter1.PrintLine("    本期可用:<%=obj.get("canuse") %>");
					Ret4 = DPsListPrinter1.PrintLine("    消费支出:<%=obj.get("outfee") %>");
					Ret4 = DPsListPrinter1.PrintLine("    其他支出:<%=obj.get("otherfee") %>");
					Ret4 = DPsListPrinter1.PrintLine("    余额:<%=obj.get("thisval") %>");
					Ret4 = DPsListPrinter1.PrintLine("    ---------------------------------");
				<%
				}
			}
			...
			<%
				// modify begin wWX217192 2014-10-13 由于剩余流量中包含负值，修改此方法BUG
			...
			<%
				...
				// modify end wWX217192 2014-10-13 由于剩余流量中包含负值，修改此方法BUG
			}
			%>
			...
			{
			%>
				Ret4 = DPsListPrinter1.PrintLine("    【现金帐本入帐明细】");
			<%
				for (Map inoutdetailMap : inoutdetailList)
				{
					if ("0".equals(inoutdetailMap.get("feetype")))
					{
			%>
						Ret4 = DPsListPrinter1.PrintLine("    时间:<%=inoutdetailMap.get("date") %>");
						Ret4 = DPsListPrinter1.PrintLine("    方式:<%=inoutdetailMap.get("model") %>");
						<%if ("1".equals(inoutdetailMap.get("type"))){%>
							Ret4 = DPsListPrinter1.PrintLine("    类别:充值");
						<%}else if ("2".equals(inoutdetailMap.get("type"))){%>
							Ret4 = DPsListPrinter1.PrintLine("    类别:返还");
						<%}else if ("3".equals(inoutdetailMap.get("type"))){%>
							Ret4 = DPsListPrinter1.PrintLine("    类别:退费");
						<%}else if ("4".equals(inoutdetailMap.get("type"))){%>
							Ret4 = DPsListPrinter1.PrintLine("    类别:账户间转移");
						<%}else if ("0".equals(inoutdetailMap.get("type"))){%>
							Ret4 = DPsListPrinter1.PrintLine("    类别:未知");
						<%}else{%>
							Ret4 = DPsListPrinter1.PrintLine("    类别:<%=inoutdetailMap.get("type") %>");
						<%}%>
						Ret4 = DPsListPrinter1.PrintLine("    金额:<%=inoutdetailMap.get("fee") %>");
						Ret4 = DPsListPrinter1.PrintLine("    备注:<%=inoutdetailMap.get("desc") %>");
						Ret4 = DPsListPrinter1.PrintLine("    ---------------------------------");
			<%
					}
				}
			...
			// 协议款账本入账明细
			Ret4 = DPsListPrinter1.PrintLine("    【协议款账本入账明细】");
			<% 
			if (inoutdetailList != null && inoutdetailList.size() > 0)
			{
				for (Map inoutdetailMap : inoutdetailList)
				{
					if ("1".equals(inoutdetailMap.get("feetype")))
					{
			%>
						Ret4 = DPsListPrinter1.PrintLine("    时间:<%=inoutdetailMap.get("date") %>");
						Ret4 = DPsListPrinter1.PrintLine("    方式:<%=inoutdetailMap.get("model") %>");
			...
			// 专有帐户入账明细
			Ret4 = DPsListPrinter1.PrintLine("    【专用帐户变更明细】");
			<% 
			if (inoutdetailList != null && inoutdetailList.size() > 0)
			{
				for (Map inoutdetailMap : inoutdetailList)
				{
					if ("2".equals(inoutdetailMap.get("feetype")))
					{
			%>
						Ret4 = DPsListPrinter1.PrintLine("    时间:<%=inoutdetailMap.get("date") %>");
						Ret4 = DPsListPrinter1.PrintLine("    方式:<%=inoutdetailMap.get("model") %>");
			...
			// 协议款账本
			Ret4 = DPsListPrinter1.PrintLine("    【协议款账本】");
			<% 
			if (inoutdetailList != null && inoutdetailList.size() > 0)
			{
				for (Map inoutdetailMap : inoutdetailList)
				{
					if ("3".equals(inoutdetailMap.get("feetype")))
					{
			%>
						Ret4 = DPsListPrinter1.PrintLine("    时间:<%=inoutdetailMap.get("date") %>");
						Ret4 = DPsListPrinter1.PrintLine("    方式:<%=inoutdetailMap.get("model") %>");
								...
								<div class="ptop180 tc p747w411h" id="inn" >
											...
											<tr>
												<td class="noLRBorder">
														<table class="tb_blue05" width="100%">
															...
															<tr>
																...
																<td class="tl"><%=startdate_format %>至<%=enddate_format %></td>
															</tr>
														</table>
												</td>
												<td class="noLRBorder">
												...
												<td class="noLRBorder">
														<table class="tb_blue05" width="100%">
															...
															<tr>
																<td class="tl">&nbsp;&nbsp;&nbsp;&nbsp;现金帐本余额</td>
																<td class="tr">
																	<%=acctbalanceMap != null && acctbalanceMap.get("leftmoney1")!=null?acctbalanceMap.get("leftmoney1"):"" %>
																</td>
															</tr>
															<tr>
																<td class="tl">&nbsp;&nbsp;&nbsp;&nbsp;协议款余额</td>
																<td class="tr">
																	<%=acctbalanceMap != null && acctbalanceMap.get("leftmoney2")!=null?acctbalanceMap.get("leftmoney2"):"" %>
																</td>
															</tr>
															<tr>
																<td class="tl">&nbsp;&nbsp;&nbsp;&nbsp;积分余额</td>
																<td class="tr">
																	<%=scoreinfoMap != null && scoreinfoMap.get("thisavail")!=null?scoreinfoMap.get("thisavail"):"" %>
																</td>
															</tr>
															<tr>
																<td class="tl"><Strong>本期消费</Strong></td>
																<td class="tr">
																	<%=acctbalanceMap != null && acctbalanceMap.get("consume")!=null?acctbalanceMap.get("consume"):"" %>
																</td>
															<tr>
															<tr>
																<td class="tl"><Strong>本期末欠款</Strong></td>
																<td class="tr">
																	<%=acctbalanceMap != null && acctbalanceMap.get("debtfee")!=null?acctbalanceMap.get("debtfee"):"" %>
																</td>
															<tr>
														</table>
												</td>
									...
									<table class="tb_blue05" width="100%">
										...
										<tr>
											...
											{
												out.print(obj.get("accttype"));
											}
											%>
											</td>
											<td><%=obj.get("lastval") %></td>
											<td><%=obj.get("income") %></td>
											<td><%=obj.get("returnfee") %></td>
											<td><%=obj.get("backfee") %></td>
											<td><%=obj.get("canuse") %></td>
											<td><%=obj.get("outfee") %></td>
											<td><%=obj.get("otherfee") %></td>
											<td><%=obj.get("thisval") %></td>
										</tr>
										<% 
										}
										%>
									...
									<table class="tb_blue05" width="100%">
										<tr>
											<th colspan="20" class="tl"><Strong>账户明细</Strong></th>
										</tr>
									</table>
									<br>
										...
										<table class="tb_blue05" width="100%">
										<tr>
											<th colspan="20" style="text-align: left;" class="tl"><Strong>现金帐本入帐明细</Strong></th>
										</tr>
										<tr>
											<th class="tc">时间</th>
											<th class="tc">方式</th>
										...
										%>
												<tr>
													<td class="tc"><%=inoutdetailMap.get("date") %></td>
													<td class="tc"><%=inoutdetailMap.get("model") %></td>
													<td class="tc">
													<%
													if ("1".equals(inoutdetailMap.get("type")))
													{
													...
													{
														out.print(inoutdetailMap.get("type"));
													}
													%>
													</td>
													<td class="tc"><%=inoutdetailMap.get("fee") %></td>
													<td class="tc"><%=inoutdetailMap.get("desc") %></td>
												</tr>
										<%
												}
											}
										...
										<table class="tb_blue05" width="100%">
										<tr>
											<th colspan="20" style="text-align: left;" class="tl"><Strong>协议款账本入账明细</Strong></th>
										</tr>
										<tr>
											<th class="tc">时间</th>
											<th class="tc">方式</th>
										...
										<table class="tb_blue05" width="100%">
										<tr>
											<th colspan="20" style="text-align: left;" class="tl"><Strong>专用帐户变更明细</Strong></th>
										</tr>
										<tr>
											<th class="tc">时间</th>
											<th class="tc">方式</th>
										...
										<table class="tb_blue05" width="100%">
										<tr>
											<th colspan="20" style="text-align: left;" class="tl"><Strong>协议款账本</Strong></th>
										</tr>
										<tr>
											<th class="tc">时间</th>
											<th class="tc">方式</th>
