				...
				<div class="b966 tc">
					...
					<div class=" p40">						
						...
						<span class="yellow fs30">
							<ul><li>业务推荐营业员的手机号码：<s:property value="rectel"/></li></ul>
						</span>
						<div class="blank60"></div>
					</div>
					...
					<div class="btn_box tc">
						<span class=" mr10 inline_block ">
							<a href="javascript:void(0);" class="btn_bg_146" onmousedown="this.className='key_down'" onmouseup="this.className='btn_bg_146';;" onclick="logout(); return false;">退出</a>
						</span>
				    </div>
				</div>
			</div>
