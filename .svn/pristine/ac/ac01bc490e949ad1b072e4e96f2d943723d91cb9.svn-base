						...
						<div class="box747W fl">
							<div style="height:444px; padding:0px 0px 5px 0px; width:747px; overflow:hidden;">
								...
								<table class="tb_blue" width="90%">
									...
									<s:iterator value="obj_priv" id="privpo" status="st">
										<tr>
											<td>
												<s:property value="#privpo.privset" />
											</td>
											<td>
												<s:property value="#privpo.freetype" />&nbsp;&nbsp;
											</td>
											<td>
												<s:property value="#privpo.total" />&nbsp;<s:property value="#privpo.attrtypeunit" />&nbsp;
											</td>
											
											<td>
												<s:property value="#privpo.surplusamount" />&nbsp;<s:property value="#privpo.attrtypeunit" />
											</td>
										</tr>
					        		</s:iterator>
								</table>
...
function sendMonthlyMsg()
{
	if(isReaptSend == 0)
	{
		...
		// 短信信息内容
		var shortMsg = "尊敬的用户，您好！您月份"+document.getElementById('month').value+"的包月量信息如下：";
		<s:iterator value="obj_priv" id="privpo" status="st">
			shortMsg = shortMsg + "<s:property value="#privpo.privset" />:";
			shortMsg = shortMsg + "<s:property value="#privpo.freetype" />(" + 
					"包月量:<s:property value="#privpo.total" /><s:property value="#privpo.attrtypeunit" />," +
					"剩余量:<s:property value="#privpo.surplusamount" /><s:property value="#privpo.attrtypeunit" />)  ";
		</s:iterator>
		shortMsg = shortMsg + ";";
