...
<%
    ...
    String bossSeq = (String) request.getAttribute("bossSeq");
    if (bossSeq == null)
    {
		bossSeq = "";
	}
		...
		function doFinish()
		{
			...
			if ("<%=canPrintReceipt %>" == "1")
			{
				...
				alert(pServNumber + "	" + pOrgName + "	" + pPrintDate + "	" + pTerminalInfo + "	" 
						+ bossSeq + "	" + pDealTime + "	" + pAmount + "	" + pDealStatus + "	" + pTerminalSeq);
				*/
				
				doPrintPayProof(pServNumber, pOrgName, pPrintDate, pTerminalInfo, bossSeq, pDealTime, pAmount,
						pDealStatus, pTerminalSeq, "", "1");
