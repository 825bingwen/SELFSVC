			...
			<div class="main" id="main">
				...
				<div class="b712">
					...
					<div class="p40">
						...
						<div class="line"></div>
						<div class="blank10"></div>
						<p class="tit_arrow" style="font-size:22px;"><span class="bg"></span>请选择号码查询方式：</p>
						<div class="blank20"></div>
        				<div class="blank5"></div>
						
						<ul class="money_list_clearfix">
							<li class="first_money_key tc">
								<a style="text-align:center;" href="#" onmousedown="this.className='hover tc'" onmouseup="this.className='tc'" onclick="doSub(2); return false;">
									前七位
								</a>
							</li>
							<li class="pt30">
							...
							<li class="first_money_key tc">
								<a style="text-align:center;" href="#" class="tc" onmousedown="this.className='hover tc'" onmouseup="this.className='tc'" onclick="doSub(3); return false;">
									后四位
								</a>
							</li>
						</ul>
