      					...
      					<div class="p40 pr0">
        					...
        					<div class="line w625"></div>
       						...
       						<div class="recharge_result tc">
       							<p class="title yellow pt25">预订成功！</p>
          						...
          						<br>
          						<!-- 
          						<a href="javascript:void(0)" class=" bt4" onmousedown="this.className='bt4on'" onmouseup="this.className='bt4';windowClose();">获取预定凭证短信</a>
          						<a href="javascript:void(0)" class=" bt4" onmousedown="this.className='bt4on'" onmouseup="this.className='bt4';windowClose();">返回首页</a>
          					 	-->
          						<a class="btn_bg_240_1" onmouseup="this.className='btn_bg_240_hover_1';doSub();">获取预定凭证短信(按0键)</a>
