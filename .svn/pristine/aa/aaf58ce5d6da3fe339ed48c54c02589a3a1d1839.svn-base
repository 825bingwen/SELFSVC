			...
			try 
			{
				...
				{					
					...
					if (parseInt(document.getElementById("tMoney").value) > 0)
					{
						...
						document.getElementById("promptMsg").innerHTML = "投币结束后，请点击缴费按钮";
					}
				}	
      					...
      					<div class="p40 pr0">
        					...
        					<div>
        					 	...
        					 	<div style="padding-top:120px; padding-left:30px; display:none" class="btn_box buy_enable fl" id="commitBusi">
        					 		<a title="交费" href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="commitBusi();return false;">交费</a>
        					 	</div>
        					</div>
      					</div>
					 </div>
