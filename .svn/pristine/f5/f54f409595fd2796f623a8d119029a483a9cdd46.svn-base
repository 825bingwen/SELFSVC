...
function pwdKeyboardUp(e)
{
	...
	%>
		...
		if(key == 49 && divFlag == '')
		{
			mainProductChangeSubmit('<s:property value="newProdName" escape="false"/>');
		}
		// 2键
		else if(key == 50 && divFlag == '')
		{
			mainProductChangeCancel();
		}
		// 确认键
					...
					<div class="con relative">
						<div class="box747W fl">
							<div
								...
								{
								%>
									<input type="button" class="btn_bg_146" style="color:#FFFFFF;"
				                    	  value="确认(按1键)" onmousedown="" onmouseup="" onclick="mainProductChangeSubmit('<s:property value="newProdName"/>')" >	
				                    	  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
				                    	  <input type="button" class="btn_bg_146" style="color:#FFFFFF;"
				                    	  value="取消(按2键)" onmousedown="" onmouseup="" onclick="mainProductChangeCancel()" >	 
								<%
								}
								else
								{
				...
				<div class="openwin_tip" id="openWin1" style="width:708px; height:392px;">
					...
					<p class="fs28 lh2" style="padding-left:50px;padding-right:50px;" id="winText" name="winText">
  					...
  					<div class="tc">
						...
						{
						%>
							<a href="javascript:void(0)" class=" bt4" onmousedown="this.className='bt4on'" onmouseup="this.className='bt4';wiWindow.close();exeMainProdCHange()">确认(按确认键)</a> 
