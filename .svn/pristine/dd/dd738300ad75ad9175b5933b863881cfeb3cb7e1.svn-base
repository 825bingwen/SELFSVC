		...
		<div class="main" id="main">
			...
			<div class="pl30">
				...
				<div class="b712">
							...
							<s:if test="tpltTempletList != null && tpltTempletList.size > 0">
								<s:iterator value="tpltTempletList" status="result" id="tpltTemplet">
									<tr align="center">
										...
										<td>
											<s:property value="#tpltTemplet.templetName" /><br />
										</td>
										<td>
											<s:property value="#tpltTemplet.monthFee" /><br />
										</td>
										<td>
											<s:if test="#tpltTemplet.brand == 'ALL'">
												所有品牌
											</s:if>
											<s:elseif test="#tpltTemplet.brand == 'BrandMzone'">
												动感地带
											</s:elseif>
					...
					<pg:paginator recordsCount="${recordCount }" pageSize="${pageSize }" page="${page }" linkUrl="prodInstall/selectProd.action" />
