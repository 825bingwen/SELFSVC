...
function doSub()
{
	...
	if(tMoney < recFee)
	{
		...
		document.getElementById('lowerTips').innerHTML 
			= '尊敬的客户，您所投币的金额不足，<BR/>请再投入' + tmpMoney +  '元';
			
		wiWindow = new OpenWindow("pls_continue", 804, 515);//打开弹出窗口例子
		return;
	}
	...
	<form name="actform" method="post">
		...
		<div class="main" id="main">
				 	...
				 	<div class="bg bg712"></div>
     					...
     					<div class="p40 pr0">
       					...
       					<div class=" pay_money_wrap2">
       					 	<p class="pay_all">
       					 		支付总金额：<span class="yellow"><s:property value="receptionFee" /></span> 元
			...
			<div class="openwin_tip" id="pls_continue" style="width:708px; height:392px;">
						...
						<p class="fs28 lh2" style="padding-left:142px;" id="winText" name="winText">
	  					...
	  					<div class="tc">
						    <div class=" clear "></div>
						    <div class=" blank30 "></div>
	    					<a title="" href="javascript:void(0)" class=" bt4 ml20" onmousedown="this.className='bt4on ml20'" onmouseup="this.className='bt4 ml20';wiWindow.close()" onclick="openWindow_cancel('loading_cancel');return false;">取消办理</a>
	    					<a title="继续投币办理" href="javascript:void(0)" class=" bt4" onmousedown="this.className='bt4on'" onmouseup="this.className='bt4';wiWindow.close();" onclick="changeIsDone();return false;">继续办理</a>  
	    				</div>
			</div>
			<!-- 弹出窗结束 -->
			...
			<script type="text/javascript">
				...
				{
						wiWindow = new OpenWindow("loading_cancel", 804, 515);//打开弹出窗口例子
						document.getElementById('commitBusi').disabled = false;
						doCancel();
				}				
			</script>
