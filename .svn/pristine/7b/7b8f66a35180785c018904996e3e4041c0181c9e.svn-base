...
function phoneSearch()
{
	...
	<body scroll="no">
		<form name="actform" method="post">		
			...
			<input type="hidden" name="netNbr" id="netNbr" value="<s:property value='netNbr' />">
    ...
    <div class="clear"></div>
  				...
  				<div class="num_foot fs18 pl18">   					
    				<s:if test="pageFlag == 'true'">
    					<pg:paginator recordsCount="${recordCount }" pageSize="${pageviewnum }" page="${page }" linkUrl="chooseTel/netNbrSearchResult.action" alignType="left" />
    				</s:if>
    				<s:else>
