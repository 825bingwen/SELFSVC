...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		//add begin by lwx439898 2017-10-19 OR_HUB_201709_456_湖北_支付中心需要 自助终端配合接口改造
		function selectPayTypes(money) 
		{
			if (submitFlag == 0)
			{
				submitFlag = 1;															
				...
				document.actform.action = "${sessionScope.basePath}" + "charge/intPayCetCharge.action?chargeMoney="+money;
				document.actform.submit();						
			}			
		}
		
		function inputMoneys()
		{	
			if (submitFlag == 0)
			{
				submitFlag = 1;
		...
		//add end by lwx439898 2017-10-19 OR_HUB_201709_456_湖北_支付中心需要 自助终端配合接口改造
				...
				<div class="pl30">
					...
					<div class="b712">
    					...
    					<div class="p40">
        					...
        					<!-- modify begin by lwx439898 2017-10-16 OR_HUB_201709_456_湖北_支付中心需要 自助终端配合接口改造 -->
        					<s:if test="payCerntWay == 'true'">
        						<ul class="money_list clearfix">
          						<li><a href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="selectPayTypes('20');return false;">20元</a></li>         								
          						<li><a href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="selectPayTypes('50');return false;">50元</a></li>
         	 					<li><a href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="selectPayTypes('100');return false;">100元</a></li>
          						<li><a href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="selectPayTypes('300');return false;">300元</a></li>
          						<li><a href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="selectPayTypes('500');return false;">500元</a></li>
          						<li><a href="javascript:void(0);" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="inputMoneys();return false;">其他金额</a></li>    						
        					</s:if>
        					<s:else>
        						<ul class="money_list clearfix">
        					...
        					<!-- modify end by lwx439898 2017-10-11 OR_HUB_201709_456_湖北_支付中心需要 自助终端配合接口改造 -->     					      						
    					</div>
					</div>
				</div>
			</div>
