...
<html>
  ...
  <body onload="qryCurBillSelfSv();">
  	  <table id="totalTab" border="0" cellpadding="0" cellspacing="0">
  	  	<tr>
  	  		<td  width="50%">
			   <table id="curBssTab1" class="tb_blue_08" height="100%" border="0" cellpadding="0" cellspacing="0">
						<tr>
		  	...
		  	<td/>
		  	<td width="50%">
			   <table id="curBssTab2" class="tb_blue_08" height="100%"  border="0" cellpadding="0" cellspacing="0">
			   </table>
		  	<td/>
		 </tr>
	  </table>
	...
	return s.replace(/^\s*/, "").replace(/\s*$/, "");
	  ...
	  var cssHeight = 25;
			...
			function changeHeight(hei)
			{
				try
				{
					parent.document.getElementById("ifr_bss").style.height = hei;
				}
				catch(e1)
				{
				}
			...
			function qryCurBillSelfSv()
			{
			    var url = "${sessionScope.basePath }hubfeeservice/curBillSelfSv.action";
			...
			function displayBillSelfSv(xmlData)
			{
				var tab1  = document.getElementById('curBssTab1');
				var tab2  = document.getElementById('curBssTab2');
				tab1.deleteRow();
				...
				for(var k=0; k<2;k++)
		  	 	{
					...
					cell.width=250;
					cell.innerHTML = "<font size=2>费用名称</font>";
					cell.align='left';
					//var cell = row.insertCell();
					var cell = document.createElement("th");
					row.appendChild(cell);
					cell.width=150;
					cell.innerHTML = "<font size=2>金额(元)</font>";
					cell.align='left';
		  	 	}
			}
			...
			function createTail(tab1,tab2,fee1,fee2)
			{
				...
				row.appendChild(cell);
				cell.width=250;
				cell.innerHTML = "<font size=2><b>" +  '费用合计' + "</b></font>";
				cell.align='left';
				//var cell = row.insertCell();
				var cell = document.createElement("th");
				row.appendChild(cell);
				cell.width=150;
				cell.innerHTML = "<font size=2>" + fee1 + "</font>";
				cell.align='left';
				var row = tab2.insertRow();
		  	 //	row.style.backgroundColor ='#8B4513';
		  	 	row.height=30;
			    ...
			    row.appendChild(cell);
				cell.width=250;
				cell.innerHTML = "<font size=2><b>" +  '' + "</b></font>";
				cell.align='left';
				//var cell = row.insertCell();
				var cell = document.createElement("th");
			    row.appendChild(cell);
				cell.width=150;
				cell.innerHTML = "<font size=2>" + fee2 + "</font>";
				cell.align='left';
			}
	</script>
  </body>
