 ...
 * 
 * 中文转换汉语拼音
 * @author  jiashengliang
 * @version  L05, May 15, 2012
 * @see  
 * @since 
 */
   ...
   /* public static void main(String[] args)
    {
        ...
        finder.setResource("获取中文首字母");
        // 获取全拼字母
        System.out.println(finder.getSpelling());
        // 获取首字母
        System.out.println(finder.getSellingHead("获取中文首字母"));
     ...
     * @return
     */
    public static synchronized ChineseSpelling getInstance()
    {
