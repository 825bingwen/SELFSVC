 ...
 * 
 */
public class FavourableInfoAction extends BaseAction
{
    
    private static Log logger = LogFactory.getLog(FavourableInfoAction.class);
     ...
     * @return
     */
    public String qryFavourableInfo()
    {
    	String forward = "qryFavourableInfo";
    	
        logger.debug("qryFavourableInfo Starting...");
        ...
        else if (result.get("returnObj") == null)
        {
            ...
            String resultMsg = getConvertMsg((String) result.get("returnMsg"), "zz_04_15_000003", 
