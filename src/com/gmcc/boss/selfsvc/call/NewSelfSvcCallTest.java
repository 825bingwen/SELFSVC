...
public class NewSelfSvcCallTest implements SelfSvcCall {
    ...
    public ReturnWrap getUserInfo(Map map) {
        String response = "<?xml version=\"1.0\" encoding=\"GBK\" ?><message_response><message_head version=\"1.0\">"
                ...
                + "<productname></productname><productgroup></productgroup><viptype></viptype>"
                + "<productname>全球通</productname><productgroup>BrandSzx</productgroup><viptype>VC0000</viptype>"
                + "<logintype></logintype><feeflag></feeflag><question></question><answer></answer><needcheckstr>"
    ...
    public ReturnWrap recChangePassword(Map map) {
        try {
            ...
            ReturnWrap rwp = new ReturnWrap();
            rwp.setStatus(0);
            rwp.setReturnMsg("系统错误，密码修改受理错误！");
...
//            				"<famCode>6348000328171</famCode><memlist>13863420044，短号552</memlist><resultList><telnum>13863420044</telnum><name>3213123</name>" +
...
//                    		"<subname>吕旭光</subname><region></region>"
...
//        }
    ...
    public ReturnWrap qrymailBox(Map map) {
        ...
        try {
            ...
            ReturnWrap rwp = new ReturnWrap();
            rwp.setStatus(0);
            rwp.setReturnMsg("查询用户是否已开通手机邮箱失败!");
    ...
    public ReturnWrap queryDetailedRecordsNX2012(Map<String, String> map) {
        ...
        if ("1".equals(cdrType)) {
            ...
            response = "<?xml version=\"1.0\" encoding=\"GBK\"?><message_response><message_head version=\"1.0\">"
                    ...
                    + "2012-12-2 13:24:33@_@深圳@_@@_@00:05:00@_@1MB1KB25B@_@5元包流量@_@2G@_@0.00|"
                    + "2012-12-2 15:24:32@_@深圳@_@@_@00:00:08@_@1MB1KB25B@_@5元包流量@_@2G@_@0.00|"
    ...
    public ReturnWrap qryHasProds(MsgHeaderPO msgHeader)
    {
        String response = "<?xml version=\"1.0\" encoding=\"GBK\" ?><Envelope><Header><request_head version=\"1.0\">"
                ...
                // 产品包 ncode:ncode_001 (表中配置的prodid)
                "<crset>" +
                    "<prodid></prodid>" +//对产品包下的子产品或者模板下的子产品，返回产品编码；其它返回“”
                    "<prodname></prodname>" +//产品名称
                    "<attrparam></attrparam>" +//附加属性串
                    ...
                    "<pkgid></pkgid>" +//对产品包下的子产品或者模板下的子产品，返回产品包编码或者模板编码；其它返回“”
                    "<prodtype>1</prodtype>" +//该字段用于标识是产品包还是NCODE，若为0标识为NCODE那么COL_0里面的值就为NCODE，若为1，COL_1里面的内容就是产品包
                    "<privid></privid>" + //优惠编码
                    "<ncode>ncode_001</ncode>" + //对产品包下的子产品或者模板下的子产品，返回“”；其它返回ncode
                "</crset>" + 
                
                // 包下子产品 subproductcode001
                "<crset>" +
                        "<prodid>subproductcode001</prodid>" +//对产品包下的子产品或者模板下的子产品，返回产品编码；其它返回“”
                        "<prodname>产品名称_subproductcode001</prodname>" +//产品名称
                        "<attrparam></attrparam>" +//附加属性串
                        "<serviceres></serviceres>" +//服务资源串
                        "<recdate>20100303210238</recdate>" +//受理时间，格式： yyyymmddhh24miss
                        "<startdate>20100303210238</startdate>" +//开始时间，格式： yyyymmddhh24miss
                        ...
                        "<pkgname></pkgname>" +//套餐大类名称
                        "<canceldate></canceldate>" +//取消时间，格式： yyyymmddhh24miss
                        "<pkgid>pkgcode_001</pkgid>" +//对产品包下的子产品或者模板下的子产品，返回产品包编码或者模板编码；其它返回“”
                        "<prodtype></prodtype>" +//该字段用于标识是产品包还是NCODE，若为0标识为NCODE那么COL_0里面的值就为NCODE，若为1，COL_1里面的内容就是产品包
                        "<privid></privid>" + //优惠编码
                        "<ncode>subprod_ncode_001</ncode>" + //对产品包下的子产品或者模板下的子产品，返回“”；其它返回ncode
                  "</crset>" +
                  
                  // 包下子产品 subproductcode002
                  "<crset>" +
                        "<prodid>subproductcode002</prodid>" +//对产品包下的子产品或者模板下的子产品，返回产品编码；其它返回“”
                        "<prodname>产品名称_subproductcode002</prodname>" +//产品名称
                        "<attrparam></attrparam>" +//附加属性串
                        "<serviceres></serviceres>" +//服务资源串
                        "<recdate>20100303210238</recdate>" +//受理时间，格式： yyyymmddhh24miss
                        "<startdate>20100303210238</startdate>" +//开始时间，格式： yyyymmddhh24miss
                  ...
                  "</crset>" +
                   ...
                   // 包下子产品下的优惠  subproductcode002 - > privid_001
                   "<crset>" +
                        "<prodid>subproductcode002</prodid>" +//对产品包下的子产品或者模板下的子产品，返回产品编码；其它返回“”
                        "<prodname>产品名称_subproductcode002</prodname>" +//产品名称
                        "<attrparam></attrparam>" +//附加属性串
    ...
    public ReturnWrap qryAddAttr(MsgHeaderPO msgHeader, String qryType, String nCode, String operType)
    {
        String response = "<?xml version=\"1.0\" encoding=\"GBK\" ?><Envelope><Header><request_head version=\"1.0\">"
            ...
            + "<Body>"
             ...
             // 多个文本
                + "<crset>" +
                    "<objid>objid</objid>" + // 对象编码
                    "<attrid>addarrtid_003</attrid>" + // 附加属性编码
                    "<attrname>亲情号码1</attrname>" + // 附加属性名称
                    "<attrtype>EDIT</attrtype>" + // 附加属性类型 MEMO，多行编辑框 SINGLE，单行编辑框 DATE，时间编辑框 SELECT，下拉列表
                    "<valuetype>STRING</valuetype>" + // 值类型 NUMBER，数字 STRING，字符串
                    "<minlength>11</minlength>" + // 附加属性值最小长度
                    "<maxlength>11</maxlength>" + // 附加属性值最大长度
                    "<ismandatory>1</ismandatory>" + // 是否必须
                    "<isshow>1</isshow>" + // 是否界面展现 0：界面不展示 1：界面展示可以编辑 2：界面展示不能编辑
                    "<attrnum>3</attrnum>" + // 属性值数量
                    "<attrsplit>@</attrsplit>" + // 附加属性分隔符
                    "<attrvalue>13645319981@13645319982@13645319984</attrvalue>" + // 用户订购值（如果用户没有订购就填充默认值）
                    "<dictinfo></dictinfo>" + // 字典信息，格式： dictid=dictname|dictid=dictname
                    "<objtype></objtype>" + // 产品/优惠/服务
                "</crset>" 
               ...
               + "<crset>" +
                   ...
                   "<maxlength>11</maxlength>" + // 附加属性值最大长度
                   "<ismandatory>1</ismandatory>" + // 是否必须
                   "<isshow>2</isshow>" + // 是否界面展现 0：界面不展示 1：界面展示可以编辑 2：界面展示不能编辑
                   "<attrnum>1</attrnum>" + // 属性值数量
                   "<attrsplit>@</attrsplit>" + // 附加属性分隔符
              ...
              "</crset>"
               ...
               + "<crset>" +
                   "<objid>objid</objid>" + // 对象编码
                   "<attrid>addarrtidbyPASSWORD_001</attrid>" + // 附加属性编码
                   "<attrname>密码1</attrname>" + // 附加属性名称
                   "<attrtype>PASSWORD</attrtype>" + // 附加属性类型 MEMO，多行编辑框 SINGLE，单行编辑框 DATE，时间编辑框 SELECT，下拉列表
                   "<valuetype>STRING</valuetype>" + // 值类型 NUMBER，数字 STRING，字符串
                   "<minlength>6</minlength>" + // 附加属性值最小长度
                   "<maxlength>6</maxlength>" + // 附加属性值最大长度
                   "<ismandatory>1</ismandatory>" + // 是否必须
                   "<isshow>1</isshow>" + // 是否界面展现 0：界面不展示 1：界面展示可以编辑 2：界面展示不能编辑
                   "<attrnum>1</attrnum>" + // 属性值数量
                   "<attrsplit>@</attrsplit>" + // 附加属性分隔符
               ...
               "<crset>" +
                   "<objid>objid</objid>" + // 对象编码
                   "<attrid>addarrtidbyPASSWORD_002</attrid>" + // 附加属性编码
                   "<attrname>密码2</attrname>" + // 附加属性名称
                   "<attrtype>PASSWORD</attrtype>" + // 附加属性类型 MEMO，多行编辑框 SINGLE，单行编辑框 DATE，时间编辑框 SELECT，下拉列表
                   "<valuetype>STRING</valuetype>" + // 值类型 NUMBER，数字 STRING，字符串
                   "<minlength>6</minlength>" + // 附加属性值最小长度
                   "<maxlength>6</maxlength>" + // 附加属性值最大长度
                   ...
                   "<attrnum>1</attrnum>" + // 属性值数量
                   "<attrsplit>@</attrsplit>" + // 附加属性分隔符
                   "<attrvalue>123456</attrvalue>" + // 用户订购值（如果用户没有订购就填充默认值）
                   "<dictinfo></dictinfo>" + // 字典信息，格式： dictid=dictname|dictid=dictname
                   "<objtype></objtype>" + // 产品/优惠/服务
               "</crset>" +
               ...
               "<crset>" +
                   "<objid>objid</objid>" + // 对象编码
                   "<attrid>addarrtidbyTEXTAREA_001</attrid>" + // 附加属性编码
                   "<attrname>多行文本</attrname>" + // 附加属性名称
                   "<attrtype>TEXTAREA</attrtype>" + // 附加属性类型 MEMO，多行编辑框 SINGLE，单行编辑框 DATE，时间编辑框 SELECT，下拉列表
                   "<valuetype>STRING</valuetype>" + // 值类型 NUMBER，数字 STRING，字符串
                   "<minlength>6</minlength>" + // 附加属性值最小长度
                   "<maxlength>20</maxlength>" + // 附加属性值最大长度
                   "<ismandatory>1</ismandatory>" + // 是否必须
                   "<isshow>1</isshow>" + // 是否界面展现 0：界面不展示 1：界面展示可以编辑 2：界面展示不能编辑
                   "<attrnum>1</attrnum>" + // 属性值数量
                   "<attrsplit>@</attrsplit>" + // 附加属性分隔符
               ...
               "<crset>" +
                   "<objid>objid</objid>" + // 对象编码
                   "<attrid>addarrtidbyMONEY_001</attrid>" + // 附加属性编码
                   "<attrname>货币</attrname>" + // 附加属性名称
                   "<attrtype>MONEY</attrtype>" + // 附加属性类型 MEMO，多行编辑框 SINGLE，单行编辑框 DATE，时间编辑框 SELECT，下拉列表
                   "<valuetype>STRING</valuetype>" + // 值类型 NUMBER，数字 STRING，字符串
                   "<minlength>6</minlength>" + // 附加属性值最小长度
                   "<maxlength>20</maxlength>" + // 附加属性值最大长度
                   "<ismandatory>1</ismandatory>" + // 是否必须
               ...
               "<crset>" +
                    "<objid>objid</objid>" + // 对象编码
                    "<attrid>addarrtidSELECT_001</attrid>" + // 附加属性编码
                    ...
                    "<minlength></minlength>" + // 附加属性值最小长度
                    "<maxlength></maxlength>" + // 附加属性值最大长度
                    "<ismandatory>1</ismandatory>" + // 是否必须
                    "<isshow>1</isshow>" + // 是否界面展现 0：界面不展示 1：界面展示可以编辑 2：界面展示不能编辑
                    "<attrnum>2</attrnum>" + // 属性值数量
                    "<attrsplit>@</attrsplit>" + // 附加属性分隔符
                    "<attrvalue>0531@0532</attrvalue>" + // 用户订购值（如果用户没有订购就填充默认值）
                    "<dictinfo>0531=济南|0532=青岛|0533=淄博|0534=潍坊|0536=聊城|0635=莱芜</dictinfo>" + // 字典信息，格式： dictid=dictname|dictid=dictname
                    "<objtype></objtype>" + // 产品/优惠/服务
                "</crset>" +
                ...
                "<crset>" +
                     "<objid>objid</objid>" + // 对象编码
                     "<attrid>addarrtidSELECT_002</attrid>" + // 附加属性编码
                     "<attrname>单选</attrname>" + // 附加属性名称
                     "<attrtype>SELECT</attrtype>" + // 附加属性类型 MEMO，多行编辑框 SINGLE，单行编辑框 DATE，时间编辑框 SELECT，下拉列表
                     "<valuetype>NUMBER</valuetype>" + // 值类型 NUMBER，数字 STRING，字符串
                     "<minlength></minlength>" + // 附加属性值最小长度
                     "<maxlength></maxlength>" + // 附加属性值最大长度
    ...
    public ReturnWrap qryNcodeTips(Map<String, String> paramMap)
    {
        String response = "<?xml version=\"1.0\" encoding=\"GBK\" ?><Envelope><Header version=\"1.0\"><response_head>" +
        		...
        		"<crset><ncode>H01</ncode><tiptype>PCTIPNORMAL</tiptype><opertype>PCOpRec</opertype><tip>43434让若人123</tip>" +
    ...
    public ReturnWrap qryChooseTelSD(Map map) {
        try {
            String response = "<?xml version=\"1.0\" encoding=\"GBK\" ?><message_response><message_head version=\"1.0\">"
                ...
                +"<![CDATA[Processing the request succeeded!]]></retmsg></retinfo></message_head><message_body>"
                +"<![CDATA[<?xml version=\"1.0\" encoding=\"GBK\" ?><message_content>"
                +"<tellist><telnum>15963852756</telnum><productinfo>未知</productinfo><fee>10000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100000</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963857319</telnum><productinfo>未知</productinfo><fee>10000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856731</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856595</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963850601</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856406</telnum><productinfo>未知</productinfo><fee>10000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856407</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856410</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856418</telnum><productinfo>未知</productinfo><fee>10000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856427</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856429</telnum><productinfo>未知</productinfo><fee>10000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856432</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856433</telnum><productinfo>未知</productinfo><fee>5000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856437</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856130</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856133</telnum><productinfo>未知</productinfo><fee>5000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856144</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856145</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856146</telnum><productinfo>未知</productinfo><fee>5000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856148</telnum><productinfo>未知</productinfo><fee>5000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856150</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856565</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856571</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856573</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856575</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856582</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856583</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856586</telnum><productinfo>未知</productinfo><fee>15000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856156</telnum><productinfo>未知</productinfo><fee>10000</fee><org_id>SD.LP</org_id><region>634</region><tellevel></tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856157</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856160</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856170</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856172</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856173</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"<tellist><telnum>15963856175</telnum><productinfo>未知</productinfo><fee>0</fee><org_id>SD.LP</org_id><region>634</region><tellevel>豆豆测试啦</tellevel><low_consum_fee>10</low_consum_fee><low_consum_pre>100</low_consum_pre><low_inservice_time>120</low_inservice_time></tellist>"
                +"</message_content>]]></message_body></message_response>";
            return intMsgUtil.parseResponse(response);
        } catch (Exception e) {
            ReturnWrap rwp = new ReturnWrap();
    ...
    public ReturnWrap authValueCard(MsgHeaderPO msgHeader, Map<String, String> paramMap)
    {
        ...
        {
           return CommonUtil.getReturnWrap(SSReturnCode.ERROR, "有价卡校验异常");
        }
    }
