	...
	<body scroll="no">
		<form name="actform" method="post">
			<input type="hidden" id="searchGroups" name="searchGroups"
				value="<s:property value='searchGroups'/>" />
			...
			<div class="main" id="main">
				...
				<div class="service_brand w966 m0auto">
					<div class="brand_list mt_26" style="margin-top: 0px;">
						<s:if test="1!= searchGroups">
							<a href="javascript:void(0);" class="btn_bg_205"
								onmousedown="this.className='btn_bg_205_hover'"
								onmouseup="this.className='btn_bg_205'"
								onclick="search_Groups('1'); return false;"> <span>语音与套餐类</span>
							</a>
						</s:if>
						<s:if test="2!=searchGroups">
							<a href="javascript:void(0);" class="btn_bg_205"
								onmousedown="this.className='btn_bg_205_hover'"
								onmouseup="this.className='btn_bg_205'"
								onclick="search_Groups('2'); return false;"> <span>增值业务类</span>
							</a>
						</s:if>
						<s:if test="3!=searchGroups">
							<a href="javascript:void(0);" class="btn_bg_205"
								onmousedown="this.className='btn_bg_205_hover'"
								onmouseup="this.className='btn_bg_205'"
								onclick="search_Groups('3'); return false;"> <span>国际业务类</span>
							</a>
						</s:if>
						<a href="javascript:void(0);" class="btn_bg_205"
							onmousedown="this.className='btn_bg_205_hover'"
							onmouseup="this.className='btn_bg_205'"
							onclick="searchFunc('1'); return false;"> <span>返回分类列表>></span>
						</a>
					</div>
					...
					<pg:paginator recordsCount="${recordCount }"
						...
						linkUrl="reception/searchGroups_sd.action" />
					...
					<div class="service_quick_search mt10 m0auto clearfix" style="margin-top: -5px;">
						<p class="brand pbleft01" style="margin-left: 90px;">
							<a class="clearfix" href="javascript:void(0);"
								...
								class="cfff200">按品牌查看</span> <span>选择您的品牌，快速查<br />找您适用的业务</span>
							</a>
						</p>
