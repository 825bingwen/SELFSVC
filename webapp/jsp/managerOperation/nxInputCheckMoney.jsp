...
function doSub()
{
	...
	document.actform.action="${sessionScope.basePath}managerOperation/insertNXAuditLog.action";
					...
					<div class=" p20">						
						...
						<div class="keyboard_wrap clearfix">
							<ul class="audit_info fl">
          						...
          						<s:iterator value="cashes" status="st" id="cash">
          							<s:if test="#st.first">
          								<li class="fs18 clearfix ti5">
		          							其中：<s:property value="#cash.cashFee" escape="false" />元，<s:property value="#cash.cashNum" escape="false" />张
		          						</li>
          							</s:if>
          							<s:else>
          								<li class="fs18 clearfix ti8">
		          							<s:property value="#cash.cashFee" escape="false" />元，<s:property value="#cash.cashNum" escape="false" />张
		          						</li>
          							</s:else>
          						</s:iterator>
        					</ul>
