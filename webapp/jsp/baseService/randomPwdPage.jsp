...
function doSub()
{
	...
	{
		// add begin hWX5316476 2014-2-20 OR_NX_201402_306 宁夏自助终端优化需求_弱密码改造需求 
		<%
		if (Constants.PROOPERORGID_NX.equalsIgnoreCase(pageProvince))
		{
		%>
		...
		%>
		// add end hWX5316476 2014-2-20 OR_NX_201402_306 宁夏自助终端优化需求_弱密码改造需求 
						...
						<div class="keyboard_wrap clearfix">
							<ul class="phone_num_list fl">
								<li class="on fs20 clearfix" id="phone_input_1">
									<i class="lh30">1.输入随机密码</i>
									<span id="redstar1" class="pl20 fl lh75">随机密码：</span>
								...
								<li class="fs20 clearfix" id="phone_input_2">
									...
									<span id="redstar2" class="pl20 fl lh75">&nbsp;&nbsp;&nbsp;新密码：</span>
								...
								<li class="fs20 clearfix" id="phone_input_3">
									...
									<span id="redstar3" class="pl20 fl lh75">确认密码：</span>
							...
							<div class="numboard numboard_big fl" id="numBoard">
								<div class=" numbox">
									...
									<a title="退格" href="javascript:void(0)" class="func1" name="functionkey"
									...
									<a title="清除" href="javascript:void(0)" class="func2" name="functionkey"
									...
									<div class="nright">
										<a title="确认" href="javascript:void(0)"
