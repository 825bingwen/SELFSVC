...
<html>
	<head>
		...
		function printInfo()
		{
			...
			{
			%>
				Ret4 = DPsListPrinter1.PrintLine("    【实际使用通信量】");	
			...
			%>
				...
				{
				%>
					Ret4 = DPsListPrinter1.PrintLine("    代付号码:<%=payedforother.get("payedtelnum") %>");
					Ret4 = DPsListPrinter1.PrintLine("    付费范围:<%=payedforother.get("paytype") %>");
					Ret4 = DPsListPrinter1.PrintLine("    本月代付:<%=payedforother.get("fee") %>");
					Ret4 = DPsListPrinter1.PrintLine("---------------------------------");
				<%
				}
				%>
		...
		function sendmail(needCheckMail)
		{
			...
			postStr = postStr + "&realbz=real";// 实时账单
							...
							<div class="div747w444h">
								...
								<div class="ptop180 tc p747w411h" id="inn" >
									...
									<table class="tb_blue05" width="100%">
										<tr>
											<th colspan="100%" class="tc">中国移动通信&nbsp;&nbsp;客户账单</th>
										</tr>
										<tr>
										...
										<table class="tb_blue05" width="100%">
											...
											%>
													<tr>
														...
														<td class="tc"><%=inoutdetailMap.get("type") %></td>
