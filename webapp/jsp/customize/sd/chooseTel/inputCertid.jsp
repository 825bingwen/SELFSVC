...
<%
    ...
    // add begin l00190940 2011-11-25 身份证倒计时不显示在输入框内
    // 省份信息
    
    String provinceSD = Constants.PROOPERORGID_SD;
    // add end l00190940 2011-11-25 身份证倒计时不显示在输入框内
...
<html>
	<head>
		...
		function doSub()
		{
			...
			// modify begin l00190940 2011-11-23 让系统对X和x均可识别
			if (!(/(^\d{15}$)|(^\d{17}([0-9]|x|X)$)/.test(certid)))   
			{
				document.getElementById('certid').focus();
				alertRedErrorMsg("请输入正确的15位或18位身份证号。");
				return false;
			}
			// modify end l00190940 2011-11-23 让系统对X和x均可识别
			...
			if (submitFlag == 0)
			{
				...
				if("1" == "<s:property value='webserviceFlag' />")
				{
					document.actform.action = "${sessionScope.basePath}chooseTel/bookNum.action";
				}
				else
				{
				...
				<div class="b712">
					...
					<div class="p40 pr0">
						...
						<div class="custom_money pl30 fl">
       					...
       					<div class="keyboard_wrap mt60 pl20 clearfix">
