			...
			//用户详单打印次数超出限制，弹出确认提示框，需要营业员输入详单打印密码 测试使用
 			...
 			var printTime = getCurrentTime();
  			doPrint_SDNew('1', "<s:property value='cdrType' />", '${sessionScope.CustomerSimpInfo.servNumber }', 
  					...
  					printTime, '${sessionScope.basePath}', '<s:property value="curMenuId" />', '代收费业务扣费记录', 
								...
								<div class="div747w444h">
									...
									<div class="ptop180 tc p747w411h" id="inn">
										...
										<table class="tb_blue03 mb10" align="center" width="100%">
											<tr>
												<th class="tl" colspan="99">语音类业务扣费记录</th>
											</tr>											
											<tr class="tr_color">
												<th width="11%">
													时间(hh:mm:ss)
											...
											<s:else>											
												...
												<tr>
													...
													<td>
														<s:property value="billTotal.dsftotaltime" />
													</td>													
													<td class="tr">
										...
										<table class="tb_blue03 mb10" align="center" width="100%">
											<tr>
												<th class="tl" colspan="99">非语音类业务扣费记录</th>
											</tr>
											<tr class="tr_color">
												<th width="11%">
													时间(hh:mm:ss)
