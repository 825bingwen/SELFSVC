	...
	<head>
		...
		function printInfo()
		{
			...
			//用户详单打印次数超出限制，弹出确认提示框，需要营业员输入详单打印密码 测试使用
       		...
       		//modify end sWX219697 2014-6-3 OR_huawei_201405_877 详单二次打印密码
			...
			<%@ include file="/titleinc.jsp"%>
				...
				<div class="main" id="main">
								...
								<div class="div747w444h">
									...
									<div class="ptop180 tc p747w411h" id="inn">
										...
										<table class="tb_blue03 mb10" align="center" width="100%">
											...
											<s:if test="%{showGprsWlanFlux == 1}">
												<s:if test="null != resultRecords && resultRecords.size > 0">
													<%--modify begin qWX279398 2015-07-24 OR_SD_201412_479_关于修改上网详单查询的汇总信息中时长字段显示的需求 --%>
													<%-- modify begin jWX216858 2014-10-13 OR_SD_201409_1541_SD_关于修改上网清单查询的汇总信息中字段显示的需求 --%>
													<tr>
														<th colspan="2">WLAN话单总条数:</th>
														<th colspan="2"><s:property value="billTotal.wlanTotalNum" />条</th>
														<th colspan="3">移动数据流量上网话单总条数:</th>
														<th colspan="2"><s:property value="billTotal.gprsTotalNum" />条</th>
														
													</tr>
													<tr>
														<th colspan="2">WLAN话单总费用:</th>
														<th colspan="2"><s:property value="billTotal.wlanTotalFee" />元</th>
														<th colspan="3">移动数据流量上网总费用:</th>
														<th colspan="2"><s:property value="billTotal.gprsTotalFee" />元</th>
													</tr>
													<%-- modify begin zKF66389 2015-6-13 OR_SD_201412_479_SD_关于修改上网详单查询的汇总信息中时长字段显示的需求 --%>
													<!-- 
													<tr>
														<th colspan="2">移动数据流量上网总时长:</th>
														<th colspan="2"><s:property value="billTotal.gprstotaltime" /></th>
														<th colspan="3">移动数据流量上网总流量:</th>
														<th colspan="2"><s:property value="billTotal.gprstotalflux" /></th>
													</tr>
													<tr>
														<th colspan="2">WLAN上网总时长:</th>
														<th colspan="2"><s:property value="billTotal.wlantotaltime" /></th>
														<th colspan="3">WLAN上网总流量:</th>
														<th colspan="2"><s:property value="billTotal.wlantotalflux" /></th>
													</tr>
													 -->
													<tr>
														<th colspan="2">WLAN上网总流量:</th>
														<th colspan="2"><s:property value="billTotal.wlantotalflux" /></th>
													    <th colspan="3">移动数据流量上网总流量:</th>
														<th colspan="2"><s:property value="billTotal.gprstotalflux" /></th>
													</tr>
													...
													<%-- add begin qWX279398 2015-8-4 OR_SD_201506_821_山东_增加宽带详单查询方案--%>
													<tr>
														<th colspan="2">有线宽带话单总条数:</th>
														<th colspan="2"><s:property value="billTotal.wiredtotalnum" />条</th>
														<th colspan="3">有线宽带上网总费用:</th>
														<th colspan="2"><s:property value="billTotal.wiredtotalfee" />元</th>
													</tr>
													
													<tr>
														<th colspan="2">有线宽带上网总时长:</th>
														<th colspan="2"><s:property value="billTotal.wiredtotaltime" /></th>
														<th colspan="3">有线宽带上网总流量:</th>
														<th colspan="2"><s:property value="billTotal.wiredtotalflux" /></th>
													</tr>
													<%-- add begin qWX279398 2015-8-4 OR_SD_201506_821_山东_增加宽带详单查询方案--%>
													
													<%-- modify end zKF66389 2015-6-13 OR_SD_201412_479_SD_关于修改上网详单查询的汇总信息中时长字段显示的需求 --%>
													<%-- modify end jWX216858 2014-10-13 OR_SD_201409_1541_SD_关于修改上网清单查询的汇总信息中字段显示的需求 --%>
													<%--modify end qWX279398 2015-07-24 OR_SD_201412_479_关于修改上网详单查询的汇总信息中时长字段显示的需求 --%>
												</s:if>
												<tr class="tr_color">
													...
													<th width="10%">上网方式</th>
													<th width="10%">时长</th>
													<th width="8%">正常时段流量</th>
													<th width="8%">优惠时段流量</th>
													<th width="15%">业务名称</th>
													<th width="12%">套餐优惠</th>
													<th width="10%">通信费(元)</th>
												</tr>
											</s:if>
											<s:else>
												<s:if test="null != resultRecords && resultRecords.size > 0">
													...
													<tr>
														<th colspan="2">WLAN话单总条数:</th>
														<th><s:property value="billTotal.wlanTotalNum" />条</th>
														<th colspan="2">移动数据流量上网话单总条数:</th>
														<th></th>
														<th><s:property value="billTotal.gprsTotalNum" />条</th>
													</tr>
													<tr>
														
														<th colspan="2">WLAN话单总费用:</th>
														<th><s:property value="billTotal.wlanTotalFee" />元</th>
														<th colspan="2">移动数据流量上网总费用:</th>
														<th></th>
														<th><s:property value="billTotal.gprsTotalFee" />元</th>
													</tr>
													<%-- modify begin zKF66389 2015-6-13 OR_SD_201412_479_SD_关于修改上网详单查询的汇总信息中时长字段显示的需求 --%>
													<!-- 
													<tr>
														<th colspan="2">移动数据流量上网总时长:</th>
														<th><s:property value="billTotal.gprstotaltime" /></th>
														<th colspan="2">移动数据流量上网总流量:</th>
														<th></th>
														<th><s:property value="billTotal.gprstotalflux" /></th>
													</tr>
													<tr>
														<th colspan="2">WLAN上网总时长:</th>
														<th><s:property value="billTotal.wlantotaltime" /></th>
														<th colspan="2">WLAN上网总流量:</th>
														<th></th>
														<th><s:property value="billTotal.wlantotalflux" /></th>
													</tr>
													 -->
													<tr>
														<th colspan="2">WLAN上网总流量:</th>
													...
													<tr>
														<th colspan="2">有线宽带话单总条数:</th>
														<th><s:property value="billTotal.wiredtotalnum" />条</th>
														<th colspan="2">有线宽带上网总费用:</th>
														<th></th>
														<th><s:property value="billTotal.wiredtotalfee" />元</th>
													</tr>
													
													<tr>
														<th colspan="2">有线宽带上网总时长:</th>
														<th><s:property value="billTotal.wiredtotaltime" /></th>
														<th colspan="2">有线宽带上网总流量:</th>
														<th></th>
														<th><s:property value="billTotal.wiredtotalflux" /></th>
													</tr>
        			...
        			<s:if test="resultRecords != null && resultRecords.size != 0">
	                    ...
	                    <!--modify begin zKF66389 2015-6-26 OR_SD_201506_580_山东_关闭自助终端的‘上网详单’的打印功能 -->
	                    <!--
						...
						-->
						<!--modify end zKF66389 2015-6-26 OR_SD_201506_580_山东_关闭自助终端的‘上网详单’的打印功能 -->
