		...
		<form name="actform" method="post">
				...
				<div class="b712">
					...
					<div class="p40">
						...
						<ul class="money_list_clearfix">
							...
							<div class="blank5"></div>	
							<li class="tel_selectrule tc">
								<a href="#" class="tc" onmousedown="this.className='hover tc'" onmouseup="this.className='tc'" onclick="doSub('bookedTelnum'); return false;">
									预约选号(按4键)
								</a>
							</li>
			...
			function goback(curmenu) 
			{
				...
				if (submitFlag == 0)
				{
					...
					document.actform.target = "_self";
					document.actform.action = "${sessionScope.basePath }cardInstall/selectProd.action";
					document.actform.submit();
				}
			}
		</script>
