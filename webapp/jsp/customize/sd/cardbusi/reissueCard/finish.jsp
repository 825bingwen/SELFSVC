		...
		<script type="text/javascript">
			...
			function printReceipt()
			{
				if (printReceiptFlag == 0 && "<s:property value='canNotPrint'/>" == "0")
				{
					...
					document.getElementById("tipResult").innerHTML = "小票打印成功，请取走。";
				}
			}
		</script>
	</head>
								...
								<p id='tipResult' class="desc pt20"></p>
			  					<div class="btn_box3_echo clearfix">
				   					<s:if test = " canNotPrint == 0 ">
				   						...
				   						<a href="javascript:void(0);" id="finishButton" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="goHomePage();return false;" style="margin-left:20px; ">补卡完成 (请按2键)</a>
				   					</s:if>
				   					<s:else>
				   						<a href="javascript:void(0);" id="finishButton" onmousedown="this.className='hover'" onmouseup="this.className=''" onclick="goHomePage();return false;" style="margin-left:180px; ">补卡完成 (请按2键)</a>
				   					</s:else>
			  					</div>
							</div>
						</div>
