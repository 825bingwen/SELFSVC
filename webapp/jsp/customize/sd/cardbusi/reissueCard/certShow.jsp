...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body scroll="no" onload="showIDImg();">
		<form name="actform" method="post">
			...
			<input type="hidden" id="oldiccid" name="simInfoPO.oldiccid" value="" />
			<input type="hidden" id="issueData" name="simInfoPO.issueData" value="" />
			<input type="hidden" id="formNum" name="simInfoPO.formNum" value="" />
