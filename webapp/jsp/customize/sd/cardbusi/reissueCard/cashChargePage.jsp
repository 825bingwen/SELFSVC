...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			{
				//未投币
				if (getValue("tMoney") == "" || parseInt(getValue("tMoney")) <= 0)
				{
					return;
				}
	...
	<body scroll="no">
		<form name="actform" method="post">
			...
			<%--------------补卡受理日志---------------%>
			<%--受理日志id，用于更新受理日志--%>
	   		<input type="hidden" id="oid" name="cardBusiLogPO.oid" 
	   			value="<s:property value = 'cardBusiLogPO.oid' />" />
			<%-- 空白卡卡号--%>
