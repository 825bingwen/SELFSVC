...
function doCash() 
{
	...
	{	
		...
		if (ret > 0) 
		{
			...
			<%--add begin zKF69263 2015/04/17 OR_SD_201502_169_山东_自助终端实现现金稽核功能--%>
			...
			<%--add end zKF69263 2015/04/17 OR_SD_201502_169_山东_自助终端实现现金稽核功能--%>
		}
		else
		{
			// 投币时长一共timeout秒
...
{		
	...
	<body scroll="no">
		<form name="actform" method="post">
			...
			<%--add begin zKF69263 2015/04/17 OR_SD_201502_169_山东_自助终端实现现金稽核功能--%>
			<%--缴费日志oid--%>
			<input type="hidden" id="chargeLogOID" name="chargeLogOID" 
				value="<s:property value='chargeLogOID' />">
			<%--add end zKF69263 2015/04/17 OR_SD_201502_169_山东_自助终端实现现金稽核功能--%>
