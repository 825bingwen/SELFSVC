	...
	<head>
		...
		function pay()
		{
			...
			try
			{
				...
				//附加信息，101：个人交费，102：代理商交费
				strin = strin + formatStr("101"+document.getElementById("chargeLogOID").value,'right',' ',100);// 移动缴费附加信息100
				...
				else if (resultstr.substring(0,6) == "000000" && strlen(resultstr) == 255)
				{
					...
					var loader1 = new net.ContentLoader(url1, netload = function () {
						...
						if (resXml1 == "1" || resXml1 == 1)
						{
							//提交缴费请求
							document.readCardForm.target = "_self";
							document.readCardForm.action = "${sessionScope.basePath }charge/cardChargeCommit.action";
							document.readCardForm.submit();										
						}
						//更新日志失败
						else
