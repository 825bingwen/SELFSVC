      					...
      					<div class="keyboard_wrap authentication authentication_2n clearfix">
      						<ul class="phone_num_list fl">
          						...
          						<li class="fs20 mt10 clearfix hidden" style="height:auto;">
          							...
          							<br />
            						<input type="password" id="randomPwd" name="randomPwd" maxlength="6" class="text1 fl relative" 
...
<script type="text/javascript">
	...
	function doSub() 
	{
		...
		if (submitFlag == 0) 
		{
			...
			document.forms[0].action = "${sessionScope.basePath }bindBankCard/noEncryptBindComit.action";
