...
<html>
	...
	<body scroll="no">
		<form name="actform" method="post">
			...
			<s:hidden id="firCommitNum2" name="firCommitNum2"></s:hidden>
					...
					<div class=" p40">
						...
						<div class="keyboard_wrap clearfix">
							<div class="keyboard_box">
								...
								<div class="phone_num_list selectInput_list fl">
									<div class="fs20 textSelect clearfix ">
										...
										<div class="textSelect_con" id="checkcon" style="display: none">
											...
											<span id="check2" onClick="showSelect('check',2)">SIM卡</span>
										</div>
									</div>
								</div>
								...
								<div class="keyboard_box_con" id="phone_input_sim" style="display: none">
									<ul class="phone_num_list selectInput_list fl">
										<li class="on fs20  clearfix h70" id="phone_input_sim1">
											<span class="pl20 fl lh75 textSelect_title">卡号：</span>
											<input type="text" class="text1 simText fl relative" name="cardNum" id="phone_input_sim_Text1"
							...
							<div class="numboard numboard_big fl" id="numBoard">
								<div class="numBoard_tabs" id="numBoard_tabs" style="display: none">
...
function showSelect(m,n)
{
    ...
    else
    {
        ...
        if(M=="check1")
        {
		    ...
		    document.getElementById('phone_input_sim_Text1').value='';
        ...
        else if(M=="check2")
        {
			...
			//begin and by gWX301560 2015-8-12 OR_SD_201506_971_山东_关于存量非实名制客户补登记相关系统支撑的需求
			document.getElementById('phone_input_msg_Text1').value='';	
			//end and by gWX301560 2015-8-12 OR_SD_201506_971_山东_关于存量非实名制客户补登记相关系统支撑的需求
			...
			lastObj2=document.getElementById(O);
			changObj(O,1);
			document.getElementById("selectMethod").value="selectSIM";
	   }
	} 
}
...
function checkBeforeSub()
{
	...
	// SIM卡验证，验证SIM卡号
	if("selectSIM" == selectMethod)
	{
		var cardNum = trim(document.actform.cardNum.value);
		if (cardNum == "")   
		{
			alertRedErrorMsg("请输入正确的卡号！");
			return false;
		}
	}
	return true;
...
function doSub()
{
	...
	{   
		submitFlag = 1;
		openRecWaitLoading();
		document.actform.action = "${sessionScope.basePath}realNameReg/verifyPwd.action";
