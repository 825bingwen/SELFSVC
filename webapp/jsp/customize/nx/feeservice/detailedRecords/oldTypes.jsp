	...
	<body scroll="no" onload="window.focus();">
		<form name="actform" method="post">
			...
			<div class="main" id="main">
				...
				<a href="#" class="bt10 fr mr43" onmousedown="this.className='bt10on fr mr43'" onmouseup="this.className='bt10 fr mr43';goback('<s:property value='curMenuId' />'); return false;" style="display:inline">返回上级</a>
				<div class="b966 tc">
				    <div class=" p40">
