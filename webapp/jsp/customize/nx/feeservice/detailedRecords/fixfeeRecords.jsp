				...
				if (resMsg == "")
				{
					...
					var printTime = getCurrentTime();
  					doPrint_NXNew('1', "<s:property value='cdrType' />", '<%=entryNumber%>',
  							"<s:property value='cycle' />", '<s:property value="startDate" />', '<s:property value="endDate" />',
  							'${sessionScope.TERMINALINFO.orgname }', printTime, '${sessionScope.basePath}',
  							'<s:property value="curMenuId" />', '套餐及固定费详单',
								...
								<div class="div747w444h">
									...
									<div class="ptop180 tc p747w411h" id="inn">
										...
										<table class="tb_blue03 mb10" align="center" width="100%">
											...
											<s:if test="fixfeeRecords == null || fixfeeRecords.size == 0">
												<tr>
											...
											<s:else>											
												<s:iterator value="fixfeeRecords" id="record">
													<tr>
														<s:generator separator="@_@" val="#record" var="fields">
															<s:iterator value="#fields" status="st">
																<s:if test="#st.index == 0 || #st.index == 3">
																	<td class="tr">	
																</s:if>
																<s:else>
																	<td class="tl">	
