...
function pwdKeyboardUp(e) 
{
	...
	else if (key == 8 || key == 32 || key == 66)
	{
		...
		if (etarget.name == 'pwd' && etarget.value == '' )
		{
			MoveLast(document.getElementById('pwd'));
		}
	}
	...
	if ((key == 8 || key == 32 || key == 66)
	 		...
	 		&&  pangu_getStrLen(trim(pwd)) == 6) 
	{
		document.forms[0].pwd.focus();
		
		changObj(document.forms[0].pwd, 1);
		
		return true;
	}
	
		if (pangu_getStrLen(trim(pwd)) == 6 && document.forms[0].pwdConfirm.value == "") 
		{
...
function doSub()
{
	...
	if( pwd.value.length != 6 || pwdConfirm.value.length != 6 )
	{
		errmsg = "密码长度应为六位";
	}
	...
	if (submitFlag == 0)
		{
			...
			document.actform.action = "${sessionScope.basePath}prodInstall/feeConfirm.action";
			document.actform.submit();
		}
	}else
	{
		setErrorInfoRegion(errmsg);
	}
}
...
<form name="actform" method="post">
	...
	<div class="main" id="main">
		...
		<div class="b712">
			...
			<div class="p40 pr0">
				...
				<div class="blank20"></div>
				<p class=" tit_info"><span class="bg"></span>设置服务密码</p>
	            <div class="line w625"></div>
				<div class="blank10"></div>
				<div class="custom_money pl30 fl">
					<span class="pl40 fs20 fl lh48">服务密码：</span>
					<input type="password" name="pwd" id="pwd" value="" maxlength="6" class="text1" onclick="changObj(this, 1);" onfocus="MoveLast(event);" />
				</div>
				<div class="blank10"></div>
				<div class="custom_money pl30 fl">
	...
	var type = 1;
	var numBoardText = document.getElementById('pwd');
