	...
	<body scroll="no">
		<form name="actform" method="post">
			...
			<div class="main" id="main">
							...
							<div
								...
								<p class="ptop180 tc" id="inn"
									...
									<table width="85%" class="tb_blue">
										...
										<s:iterator value="#request.mrInfoList" id="data" status="st">
											<tr>
												<td>
													<s:property value="#data.billCycle" />
												</td>
												<td>
													<s:property value="#data.storeFlowamt" />
												</td>
												<td>
													<s:property value="#data.storeBalance" />
												</td>
												<td>
													<s:property value="#data.giftFlowamt" />
												</td>
												<td>
													<s:property value="#data.giftBalance" />
												</td>
											</tr>
										</s:iterator>
										<tr>
											<td colspan="100">
												<strong>&nbsp;&nbsp;&nbsp;&nbsp;合计条数：</strong>
												<s:property value="#request.infoSize" />
												条
											</td>
										</tr>
									</table>
				...
				<script type="text/javascript">
myScroll = new virtualScroll("inn", "gunDom");</script>
				<!--滚动条结束-->
			</div>
