		...
		<form name="readCardForm" method="post" target="_self">
			...
			<div class="popupWin fs28 credit_pls_wait" id="pls_takingcard">
					<div class="bg"></div>
	                  	...
	                  	<p class="tit_info">尊敬的客户，请您30秒内取出银联卡，当前剩余<input class="sptext" type="text" id="eTime" name="eTime" value="30" readonly="readonly" />秒</p>
	                	<div class="line"></div>
			...
			<script type="text/javascript">
				...
				{
						wiWindow = new OpenWindow(id, 804, 515);//打开弹出窗口例子
						startTakeOutClock();
				}	
				//定时循环调用取卡接口
