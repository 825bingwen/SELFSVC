...
<html>
	...
	<body scroll="no" >
		<form name="actform" method="post">
			...
			<input type="hidden" name="gprsWlanType" value="<s:property value='gprsWlanType' />">
							...
							<div class="box747W fl">
								<div style="height:444px; padding:0px 0px 5px 0px; width:747px; overflow:hidden;">
									<p class="tit_info mb10" align="left">
										<span class="bg"></span>
										上网详单
										<s:if test="'ALL' == gprsWlanType">
											(全部)
										</s:if>
										<s:elseif test="'GPRS' == gprsWlanType">
											(GPRS)
										</s:elseif>
										<s:else>
											(WLAN)
										...
										<table class="tb_blue03 mb10" align="center" width="100%">
											...
											<s:else>											
												...
												<tr class="bold">
													...
													<td class="leftBorder">
														<s:property value="billTotal.totalSeconds" />
													</td>															
													<td class="leftBorder">
														<s:property value="billTotal.totalNetwork" />
													</td>
												</tr>	
												<!-- add by xkf57421 for 备注内容 begin -->	
												<s:if test="'ALL' == gprsWlanType">
													<tr class="bold">
													<td class="leftBorder" colspan="5">
														备注：详单中的时长为您的使用时长，因计费时不足1分钟按1分钟计，故计费时长一般大于使用时长，1M=1024K。
													</td>
													</tr>	
												</s:if>
												<s:elseif test="'GPRS' == gprsWlanType">
