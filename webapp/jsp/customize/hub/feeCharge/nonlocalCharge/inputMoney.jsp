...
<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<div class="main" id="main">
				...
				<div class="pl30">
					<div class="b257 ">
    					...
    					<a href="javascript:void(0)" class="on">3. 输入金额</a> 
					...
					<div class="b712">
    					...
    					<div class="p40 pr0">
    						...
    						<p class="tit_arrow" style="font-size:22px;"><span class="bg"></span>请输入您要充值交费的金额：<span class="yellow">（<s:property value="minMoney"/>元-<s:property value="maxMoney"/>元 ) </span>：</p>
	...
	function pwdKeyboardDown(e)
	{
		...
		// 密码键盘输入金额，不能大于3000
		if(parseInt(parseInt(document.getElementById("yingjiaoFee").value)*10 + key - 48) > '<s:property value="maxMoney"/>')
		{
			return false;
		}
	}
	...
	function goback(menuid)
	{
		if (submitFlag == 0)
		{
			...
			document.forms[0].action = "${sessionScope.basePath }nonlocalChargeHUB/cardCharge.action";
