...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		{
			var money = document.getElementById("yingjiaoFee").value;
			if (submitFlag == 0)
			{
				submitFlag = 1;				
				document.actform.target = "_self";
		...
		function goback(menuid)
		{
			if (submitFlag == 0)
			{
				...
				document.forms[0].action = "${sessionScope.basePath }charge/selectOtherFee.action";
				...
				<div class="pl30">
					...
					<div class="b712">
    					...
    					<div class="p40 pr0">
        					...
        					<div class="keyboard_wrap mt5 clearfix" style="position:absolute; left:100px; margin-top:20px; +top:120px;">
        						...
        						<div class="numboard numboard_big numboard_small2 fl" id="numBoard">
        							<div class=" numbox clearfix">
            							...
            							<s:if test="payCerntWay == 'true'">
        										<div class="nright"> 
            									<a href="javascript:void(0)" class="func3" name="functionkey" id="numBoardEnter" onmousedown="this.className='func3on'" onmouseup="this.className='func3'" onclick="selectPayTypes();return false;">1</a> 
            									</div>
        							    </s:if>
            							<s:else>
            									<div class="nright"> 
            							...
            							<!-- modify end by lwx439898 2017-10-16 OR_HUB_201709_456_湖北_支付中心需要 自助终端配合接口改造 -->        							           							
            							<div class="blank10"></div>
          							</div>
        						</div>
        						<script type="text/javascript">
