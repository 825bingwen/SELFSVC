...
//			}
			...
			if (submitFlag == 0)
			{
				...
				if("<%=actFlag%>" == "1")
				{
					...
					{
						document.actform.action = "${sessionScope.basePath}recommendActivity/qryRecommendActList.action?feeChargeFlag=1";
					}
					else
					{
						document.actform.action = "${sessionScope.basePath}recommendProduct/getRecommendProductList.action?feeChargeFlag=1";
					}
