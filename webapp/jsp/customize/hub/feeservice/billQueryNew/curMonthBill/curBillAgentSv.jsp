...
<html>
  ...
  <body onload="qryCurBillAgentSv();">
    <table id="curBaSvTab" class="tb_blue_08"  width="100%" border="0" cellpadding="0" cellspacing="0">
			<tr>
	...
	<script type="text/javascript">
			function changeHeight(hei)
			{
				try
				{
					parent.document.getElementById("ifr_asv").style.height = hei;
				}
				catch(e1)
				{
				}
			...
			function qryCurBillAgentSv()
			{
				var url = "${sessionScope.basePath }hubfeeservice/curBillAgentSv.action";
			...
			function displayBillAgentSv(xmlData)
			{
				var tab = document.getElementById('curBaSvTab');
				tab.deleteRow();
			...
			function createHeadOrTail(tab,array)
			{
			    ...
			    for(var k=0; k<array.length; k++)
			    {
			    	...
			    	cell.innerHTML = "<font size=2>" + array[k] + "</font>";
					cell.align = "left";
			    }
			}
