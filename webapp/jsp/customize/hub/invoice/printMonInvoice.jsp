...
<script type="text/javascript">
    ...
    function doFinish() 
    {
        printMonInvoiceHB("<s:property value='monInvoicePO.printyear'/>",
                        "<s:property value='monInvoicePO.printmonth'/>",
                        "<s:property value='monInvoicePO.printday'/>",
                        "<s:property value='monInvoicePO.customerName'/>",
                        "<s:property value='monInvoicePO.servNumber'/>",
                        ...
                        "<s:property value='monInvoicePO.thirdPay'/>");
