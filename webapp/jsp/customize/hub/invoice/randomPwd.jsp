...
<%	
	...
	String formnum = (String) request.getAttribute("formnum");
...
<html>
	<head>
		...
		function doSub() 
		{
			...
			if (submitFlag == 0) 
			{
				...
				document.forms[0].action = "${sessionScope.basePath }invoice/printInvoiceWithPwd.action";
	...
	<body scroll="no" onload="document.getElementById('randomPwd').focus();">
		<form id="actform" name="actform" method="post">
			...
			<input type="hidden" id="billCycle" name="billCycle" value="<%=billCycle %>">
			<input type="hidden" id="formnum" name="formnum" value="<%=formnum %>" >		
			...
			<div class="main" id="main">
				...
				<div class="b966 hidden">
    				...
    				<div class=" pl62">
    					...
    					<div class="blank30"></div>
      					<p class="fs18 mt10"><span class="red fs18" ></span></p>
