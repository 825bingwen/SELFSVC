...
function printInfo()
{
	...
	Ret4 = DPsListPrinter1.PrintLine("      ");
	Ret4 = DPsListPrinter1.PrintLine("      身份证号码：");
	Ret4 = DPsListPrinter1.PrintLine("      <s:property value='certid' />");
	Ret4 = DPsListPrinter1.PrintLine("      ");
		...
		<div class="b966 tc">
			...
			<div class=" p40">
				...
				<span class="yellow fs30">
					...
					<ul id="successMSG" style="display:none;"><li>您预约的号码：<s:property value="telnum"/>&nbsp;已成功预约!&nbsp;&nbsp;&nbsp;&nbsp;</li></ul>

					<ul id="errorMSG" style="display:none;"><li><s:property value="alertMsg"/></li></ul>
...
<%--add begin lWX431760 2017-02-24 OR_HUB_201611_276_【BOSS常规需求】自助终端号码预约功能优化的需求 --%>
<script type="text/javascript">
	if ('<s:property value="successBz" />' == '0' && window.parent.isPrintFlag != 1)
	{
		document.getElementById("successMSG").style.display = "block";
	}
	else if ('<s:property value="successBz" />' == '0' && window.parent.isPrintFlag == 1)
	{
		doFinish();
		document.getElementById("successMSG").style.display = "block";
	}
