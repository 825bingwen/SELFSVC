...
function selectTelNum(telnum,payfee,minimumCharge)
{
	...
	document.getElementById('winText').innerHTML = '<span class="yellow">您选择预订：</span>号码：' + telnum + '</br><span class="ml20">预存费：</span><span class="">' + displayFee + '</span>元'+'</br><span class="ml20">最低消费：</span><span class="">' + displayMinimumCharge + '</span>元';
}
			...
			<div class="main" id="main">
				...
				<div class="box842W fl ml20 relative tab_966 tab_966_brand" style="display:inline">
					<div class="bg2"></div>
 					...
 					<div class="num_dis"> 
 						<s:iterator value="serverNumList" id="servNumPO">
 							<a title="" onclick="selectTelNum('<s:property value="#servNumPO.telnum" />', '<s:property value="#servNumPO.seltel_prepayfee" />','<s:property value="#servNumPO.minimumCharge" />')" href="javascript:void(0)">
 								<span></span><s:property value="#servNumPO.telnum" />
 							</a>
 						</s:iterator>
 						<div class="clear"></div>
  					</div>
				...
				function gotoPrintSuccess(){
					setTimeout(
						function(){
							wiWindow.close();
							<%--modify begin lWX431760 2017-01-09 OR_HUB_201611_276_自助终端号码预约功能优化 --%>
								document.actform.target="_self";
								document.actform.action="${sessionScope.basePath }chooseTel/inputIdCard.action";
								document.actform.submit();
							<%--modify end lWX431760 2017-01-09 OR_HUB_201611_276_自助终端号码预约功能优化 --%>
