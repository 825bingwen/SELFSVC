...
function phoneSearch()
{
	...
	<body scroll="no">
		<form name="actform" method="post">		
			...
			<input type="hidden" name="netValue" id="netValue" value="<s:property value='netValue' />">
...
<div class="box842W fl ml20 relative tab_966 tab_966_brand" style="display:inline">
  ...
  <div class="num_dis"> 
    ...
    %>
    <%-- modify begin lWX431760 2018-03-12 R005C20LG2701 DTS2018031207087_P20180129003关于自助终端选号同一号码出现两种最低消费提示  --%>
  	...
  	<%-- modify end lWX431760 2018-03-12 R005C20LG2701 DTS2018031207087_P20180129003关于自助终端选号同一号码出现两种最低消费提示  --%>
  	<%
  	}
  	%>
    <div class="clear"></div>
  ...
  <div class="num_foot fs18 pl18">  
    	<s:if test="pageFlag == 'true'">
    						<pg:paginator recordsCount="${recordCount }" pageSize="${pageviewnum }" page="${page }" linkUrl="chooseTel/netValueSearchResult.action" alignType="left" />
    					</s:if>
    					<s:else>
    ...
    <div class="fright1"> 
        ...
        <a title="预订" href="javascript:void(0)" class="bt2 fr relative fl"  onmousedown="this.className='bt2on fl relative'" onmouseup="this.className='bt2 fl relative';openWindow('openWin1')">预订</a> </div>
  </div>
</div>
...
<div class="openwin_tip" id="openWin1">
  ...
  <div class="tc">
    ...
    <a title="确认" href="javascript:void(0)" class=" bt4" onmousedown="this.className='bt4on'" onmouseup="this.className='bt4';wiWindow.close();openWindowloading('openWinLoading')">确认</a> <a title="" href="javascript:void(0)" class=" bt4 ml20" onmousedown="this.className='bt4on ml20'" onmouseup="this.className='bt4 ml20';wiWindow.close()">取消</a> </div>
</div>
