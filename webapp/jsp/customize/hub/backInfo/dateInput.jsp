	...
	<head>
		...
		function doSub()
		{
			...
			if (submitFlag == 0)
			{
				...
				var menuId="<s:property value='curMenuId' />";
				
				if(menuId=='backAbortSAndStopInfoQuery'){
					document.actform.action="QueryAbortBackInfoByDate.action?startDate="+startDate+"&endDate="+endDate;
					
				}else if(menuId=='ecashReturnInfoQuery'){
					
				document.actform.action="ecashReturnInfoQuery.action?startDate="+startDate+"&endDate="+endDate;
				}else{
					document.actform.action="QueryAllBackInfoByDate.action?startDate="+startDate+"&endDate="+endDate;
				}
						...
						<div class="keyboard_wrap clearfix">
							<ul class="phone_num_list fl">
          						<li class="on fs20 clearfix" id="phone_input_1" >
          							<i class="lh30">1.请输入开始日期(格式：201101)</i>
          							<span class="pl20 fl lh75">开始日期：</span>
            						<input type="text" maxlength="6" id="numBoardText1" name="startDate_1" class="text1 fl relative" onclick="moveLast(this);changObj(this, 1);" onfocus="moveLast(this);" />
          						</li>
          						<li class="fs20 clearfix" id="phone_input_2">
          							<i class="lh30">2.请输入结束日期(格式：201101)</i>
          							<span class="pl20 fl lh75">结束日期：</span>
            						<input type="text" maxlength="6" id="numBoardText2" name="endDate_1" class="text1 fl relative" onclick="moveLast(this);changObj(this, 2);" onfocus="moveLast(this);" />
         						</li>         
        					</ul>
