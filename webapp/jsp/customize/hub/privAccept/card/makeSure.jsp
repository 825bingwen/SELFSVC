...
<%
String yuanMoney = (String) request.getAttribute("privMoney");
	...
	<head>
		...
		************************************************/
		...
		{			
			...
			//document.actForm.action = "${sessionScope.basePath }privAccept/goCardError.action";
			document.actForm.action = "${sessionScope.basePath }privAccept/goCardError.action?errPosResCode=" + document.getElementById('posResCode').value;
		...
		function payToBoss() 
		{
			...
			document.actForm.target = "_self";
			//modified by xkf57421 for XQ[2011]_10_082 begin
			//document.actForm.action = "${sessionScope.basePath }privAccept/privCardCommit.action";
			document.actForm.action = "${sessionScope.basePath }privAccept/privCardCommit.action?cmtPosResCode=" + document.getElementById('posResCode').value;
			//modified by xkf57421 for XQ[2011]_10_082 end
			document.actForm.submit();			
		}
		...
		function fPosPay()
		{
			try
			{
				...
				//扣款之前记录日志
				var url = "${sessionScope.basePath }privAccept/addChargeLog.action";
				
				var params = "servnumber=" + <s:property value='servnumber' /> + "&paytype=1&tMoney=" + <s:property value='privMoney' />;
				...
				var loader = new net.ContentLoader(url, netload = function () {
						...
						if (dataArray[0] == "1") 
						{
							...
							try
							{
								...
								{
									setException("银联卡扣款失败，不能继续进行充值操作。请取走您的银联卡。原因："+payReturnStr);
									return;
								}
								//modified by xkf57421 for XQ[2011]_10_082 end
								...
								**/
								...
								{			
									...
									//更新日志
									var url1 = "${sessionScope.basePath }privAccept/updateCardChargeLog.action";
									...
									var loader1 = new net.ContentLoader(url1, netload = function () {
										...
										{	
											setException("银联扣款成功，但是更新日志失败，不能进行充值。请取走您的银联卡。");
				...
				<div class="pl30">
					...
					<div class="b712">
    					...
    					<div class="p40">
    						...
    						<p class="fs22 fwb pl40 lh30">交费金额：<span class="yellow fs22"><s:property value="privMoney" /></span> 元</p>
