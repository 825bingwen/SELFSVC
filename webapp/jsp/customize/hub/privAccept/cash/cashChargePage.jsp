...
function goback(menuid)
{
	...
	if (submitFlag == 0)
	{
		...
		document.actform.action = "${sessionScope.basePath }privAccept/qryPriv.action";
...
function doSub()
{
	...
	if (submitFlag == 0)
	{
		...
		//提交缴费请求
		document.actform.target = "_self";
		document.actform.action = "${sessionScope.basePath }privAccept/privCashCommit.action";
		document.actform.submit();
	}
}
...
{			
	...
	// 异常处理，只要出现了异常就要记录日志  
	document.actform.target = "_self";
	document.actform.action = "${sessionScope.basePath }privAccept/goCashError.action";
	document.actform.submit();
}		
				 	...
				 	<div class="bg bg712"></div>
     					...
     					<div class="p40 pr0">
       					...
       					<div class=" pay_money_wrap2">
       					 	<p class="pay_all">
       					 		支付总金额：<span class="yellow"><s:property value="privMoney" /></span> 元
       					...
       					<div class="blank30"></div>
       					<div>
       					 	<img src="${sessionScope.basePath }images/rmb.gif" style="float:left; padding-left:160px;" />
